...
import com.wechat.protocol.reverse.ReverseResData;
import com.wechat.protocol.scan.ScanPayReqData;
import com.wechat.protocol.scan.ScanPayResData;
import com.wechat.service.OrderQueryService;
import com.wechat.service.ReportService;
import com.wechat.service.ReverseService;
import com.wechat.service.ScanPayService;
...
public class ScanPayRequest {
    ...
    public ScanPayRequest() throws IllegalAccessException, ClassNotFoundException, InstantiationException {
    ...
    // 打log用
    private static Log log = new Log(ScanPayRequest.class);
    ...
    public void run(ScanPayReqData scanPayReqData, ResultListener resultListener) throws Exception {
        ...
        ScanPayResData scanPayResData = (ScanPayResData) Util.getObjectFromXML(payServiceResponseString,
    ...
    private boolean doOneReverse(String outTradeNo) throws Exception {
        ...
        Thread.sleep(waitingTimeBeforeReverseServiceInvoked);// 等待一定时间再进行查询，避免状态还没来得及被更新
