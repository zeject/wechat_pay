...
import com.wechat.protocol.downloadbill.DownloadBillReqData;
import com.wechat.protocol.downloadbill.DownloadBillResData;
import com.wechat.protocol.report.ReportReqData;
import com.wechat.protocol.report.service.ReporterFactory;
import com.wechat.service.DownloadBillService;
...
public class DownloadBillRequest {
    ...
    public DownloadBillRequest() throws IllegalAccessException, ClassNotFoundException, InstantiationException {
    ...
    // 打log用
    private static Log log = new Log(DownloadBillRequest.class);
    ...
    public void run(DownloadBillReqData downloadBillReqData, ResultListener resultListener) throws Exception {
        ...
        try {
            ...
            ReportReqData reportReqData = new ReportReqData(downloadBillReqData.getDevice_info(),
                    Configure.DOWNLOAD_BILL_API, (int) (totalTimeCost), // 本次请求耗时
    ...
    public void setResult(String result) {
        DownloadBillRequest.result = result;
    }
