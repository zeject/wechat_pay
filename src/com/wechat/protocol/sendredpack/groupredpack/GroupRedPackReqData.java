package com.wechat.protocol.sendredpack.groupredpack;
...
public class GroupRedPackReqData {
     ...
     * @param re_openid    接受红包的用户 接收红包的种子用户（首个用户） 用户在wxappid下的openid
     * @param total_amount 付款金额，单位分
     * @param total_num    红包发放总人数，即总共有多少人可以领到该组红包（包括分享者）
     * @param wishing      红包祝福语
     * @param act_name     活动名称
     * @param remark       备注信息
     */
    public GroupRedPackReqData(String mch_billno, String send_name, String re_openid, int total_amount, int total_num,
    ...
    public GroupRedPackReqData build() {
        // 根据API给的签名规则进行签名
