package com.wechat.protocol.orderquery;
...
public class OrderPayQueryReqData {
     ...
     * @throws Exception
     */
    public OrderPayQueryReqData(String transactionID, String outTradeNo) {
    ...
    public OrderPayQueryReqData build() {
        // 根据API给的签名规则进行签名
